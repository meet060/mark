    ...
    if (_common.page == "6") {
        ...
        $.ajax({
            ...
            success: function(lianxi) {
                ...
                console.log(_lianxi)
                if (_common.lug !== "en") {
                    _lianxi_box.find("h3").html(_lianxi.companyCn)
                    _lianxi_box.find("p").eq(0).html('联系人：' + _lianxi.nameCn)
                    _lianxi_box.find("p").eq(1).html('手机：' + _lianxi.cellPhoneCn)
                    _lianxi_box.find("p").eq(2).html('电话：' + _lianxi.phoneCn)
                    _lianxi_box.find("p").eq(3).html('传真：' + _lianxi.cellPhoneCn)
                    ...
                    _lianxi_box.find("p").eq(1).html('手机：' + _lianxi.cellPhoneEn)
                    _lianxi_box.find("p").eq(2).html('电话：' + _lianxi.phoneEn)
                    _lianxi_box.find("p").eq(3).html('传真：' + _lianxi.cellPhoneEn)

...
function head_foot_txt(e) {
    ...
    if (e == "cn") {
        ...
        //     foot_bot = '<div class="g-footer">' +
        //         '<div class="g-foot-btn">' + dongya.jiaru + '</div><p>' + dongya.beian + '<a href="http://icp.chinaz.com/home/info?host=hdzrsl.cn" style="color: #B2B2B2"> | 冀ICP备14008699号-4</a></p >' +
        //         '</div>'
        // }
...
var pro_box = {
    "pro_1": {
        ...
        aqTxtEn: "<p> Comply with national GB / T10454-2000 executive standard and European ISO21898 executive standard </ p>" + "<p> Specifications: 105X105X120cm (size can be customized) </ p>" + "<p> The inlet can be customized and the outlet can be customized. </ p>" + "<p> For transportation of non-flammable and explosive items, and there are no flammable solvents or gases around the container </ p>",
    ...
    "pro_2": {
        ...
        aqTxtEn: "<p> Specification size: 90X90X120cm (can be customized according to requirements) </ p>" + "<p> Inlet and outlet openings and lifting ring height can be customized according to customer equipment </ p>" + "<p> For transportation of non-flammable and explosive items, and there are no flammable solvents or gases around the container </ p>",
        jzTxtEn: "It is forbidden to transport flammable and explosive materials, and it is forbidden to place flammable and explosive solvents and gases around the environment of use.",
        protxt1En: "TYPE-A heavy-duty container is made of ordinary polypropylene material or other non-conductive materials. When filling or emptying the container, the movement of the goods inside the container will cause static electricity Generation. An essential defect of Type A FIBC is that it does not have any mechanism to dissipate static electricity, so it cannot prevent the generation of high-strength dangerous propagating brush discharge PBD. For this type of FIBC, generally in There is no requirement for static electricity prevention and control, so there is no need for static electricity testing, no specific test standards, and no need to affix classification labels. Although TYPE-A type container bags can be affixed, people rarely do so. If there is no label such as type B, type C or type D on the bag, then the container bag can be regarded as type A. ",
    ...
    "pro_3": {
        ...
        titleH2En: "TYPE-A lacing FIBC <em> / anti-expansion FIBC / common FIBC / without antistatic function </em>",
        aqTxtEn: "<p> Specification size: 105X105X120cm (can be customized according to requirements) </ p>" + "<p> Inlet and outlet openings and lifting ring height can be customized according to customer equipment </ p>" + "<p> For transporting dry, flammable powders. No flammable solvents or gases around the FIBC. </ p>",
    ...
    "pro_4": {
        ...
        aqTxtEn: "<p> Specification size: 105X105X120cm (can be customized according to requirements) </ p>" + "<p> Inlet and outlet openings and lifting ring height can be customized according to customer equipment </ p>" + "<p> It is used to transport flammable powder. When there is flammable solvent or gas around the container, this product can avoid static ignition. </ p>",
    ...
    "pro_7": {
        ...
        aqTxtEn: "<p> Specifications: 105X105X120cm (size can be customized) </ p>" + "<p> The inlet can be customized and the outlet can be customized. </ p>" + "<p> For transportation of non-flammable and explosive items, and there are no flammable solvents or gases around the container </ p>",
        jzTxtEn: "It is forbidden to transport flammable and explosive materials, and it is forbidden to place flammable and explosive solvents and gases around the environment of use.",
    ...
    "pro_8": {
        ...
        aqTxtEn: "<p> Specifications: 95X95X100cm (size can be customized) </ p>" + "<p> The inlet can be customized and the outlet can be customized. </ p>" + "<p> It is used to transport non-flammable and explosive items, and there is no flammable solvent or gas around the container. It is mainly used to load and transport potatoes, sweet potatoes, garlic and other agricultural crops. </ p>",
        jzTxtEn: "It is forbidden to transport flammable and explosive materials, and it is forbidden to place flammable and explosive solvents and gases around the environment of use.",
...
function lianxiApi() {
    $.ajax({
        ...
        success: function (lianxi) {
            var _lianxi = lianxi[0]
            if (_common.lug !== "en") {
                $(".g-foot-c p").eq(0).html(_lianxi.companyCn);
                $(".g-foot-c p").eq(1).html('联系人：' + _lianxi.nameCn);
                $(".g-foot-c p").eq(2).html('手机：' + _lianxi.cellPhoneCn);
                $(".g-foot-c p").eq(3).html('电话：' + _lianxi.phoneCn);
                ...
                $(".g-foot-c p").eq(2).html('手机：' + _lianxi.cellPhoneEn);
                $(".g-foot-c p").eq(3).html('电话：' + _lianxi.phoneEn);
